...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'a URL of an html page')
        .parse(process.argv);
	if (program.file && program.url) {
		console.error('Only a file OR a url should be provided - not both!');
	} else {
		var htmlFile;
		if (program.file) {
			...
			htmlFile = "temp.html";
			var fillHtml = buildfn(htmlFile);
			rest.get(program.url).on('complete', fillHtml);
		}
	}
} else {
